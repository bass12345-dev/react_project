export const Cards = ({ row_card_item }: { row_card_item: any }) => {
    let _classes = `block w-full md:w-64 px-4 py-2  rounded-lg shadow hover:bg-gray-100  dark:bg-red-800 dark:border-gray-700 dark:hover:bg-red-500 ${row_card_item.color}`;
    return (
